...
const sampleReviews: Review[] = [
  ...
  },
  {
    ...
    rating: 4,
    date: '12/03/2026',
    body: 'Trải nghiệm hot stone rất tuyệt. Đá nóng giúp thư giãn cơ bắp hiệu quả. Không gian yên tĩnh và nhân viên chu đáo.',
  ...
  },
  {
    ...
    rating: 3,
    date: '08/03/2026',
    body: 'Facial ok nhưng thời gian hơi ngắn so với mong đợi. Nhân viên thân thiện. Giá cả hợp lý.',
  ...
  },
  {
    ...
    rating: 5,
    date: '05/03/2026',
    body: 'Aromatherapy ở đây rất đặc biệt! Tinh dầu thơm dịu, kỹ thuật massage chuyên nghiệp. Cảm giác như được tái sinh sau buổi trị liệu.',
...
export default () => {
  ...
  const getReviews = async () => {
    setLoading(true);
    try {
      // TODO: gọi API lấy danh sách reviews

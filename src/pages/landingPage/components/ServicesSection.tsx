...
const fallbackIcons: React.ReactNode[] = [
	<SkinOutlined key='skin' />,
	<StarOutlined key='star' />,
	<ExperimentOutlined key='experiment' />,
	<CustomerServiceOutlined key='service' />,
	...
	return (
		...
		>
			<div className='flex flex-col items-center gap-3 text-center'>
				...
				>
					Trải nghiệm các liệu trình được thiết kế tỉ mỉ, giúp khôi phục sự cân bằng tự nhiên và mang lại cảm giác tươi
					mới cho bạn.
				</p>
			</div>
			...
			<ServiceDetailModal visible={modalVisible} service={selectedService} onClose={() => setModalVisible(false)} />
		</section>
	);
};
...
function ServiceCard({ icon, gradient, service, onViewDetail }: ServiceCardProps) {
	return (
		<div
			...
			{service.imageUrl ? (
				<img
					...
					style={{
						...
						borderRadius: 16,
						display: 'block',
						boxShadow: '0 10px 22px rgba(180, 130, 130, 0.18)',
					}}
				/>
			) : (
				<div
